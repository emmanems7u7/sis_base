        ...
        <div class="col-md-7 mb-3">
            ...
            <div class="form-check mb-2">
                <input class="form-check-input config-radio" type="radio" name="config_modulo_{{ $modulo->id }}"
                    ...
                    value='{"modo":"mostrar_todos"}' @if(isset($config['modo']) && $config['modo'] === 'mostrar_todos')
                    checked @endif>
            ...
            <div class="form-check mb-2">
                <input class="form-check-input config-radio" type="radio" name="config_modulo_{{ $modulo->id }}"
                    id="configAcordeon_{{ $modulo->id }}" data-modulo-id="{{ $modulo->id }}" value='{"modo":"acordeon"}'
                    @if(isset($config['modo']) && $config['modo'] === 'acordeon') checked @endif>
            ...
            <div class="form-check mb-2">
                <input class="form-check-input config-radio" type="radio" name="config_modulo_{{ $modulo->id }}"
                    id="configPestanas_{{ $modulo->id }}" data-modulo-id="{{ $modulo->id }}" value='{"modo":"pestanas"}'
                    @if(isset($config['modo']) && $config['modo'] === 'pestanas') checked @endif>
            ...
            <div class="form-check mb-2">
                <input class="form-check-input config-radio" type="radio" name="config_modulo_{{ $modulo->id }}"
                    id="configSelector_{{ $modulo->id }}" data-modulo-id="{{ $modulo->id }}" value='{"modo":"selector"}'
                    @if(isset($config['modo']) && $config['modo'] === 'selector') checked @endif>
