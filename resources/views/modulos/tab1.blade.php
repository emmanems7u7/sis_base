    ...
    <div class="col-md-7">
        ...
        <div class="row">
            ...
            <div class="col-md-7 mb-3">
                <h6>Tipo de visualización si existen más de un formulario</h6>
            @php
            ...
            @endphp
              ...
              <div class="form-check mb-2">
                <input class="form-check-input config-radio" type="radio" name="config_modulo_{{ $modulo->id }}" 
                    id="configMostrarTodos_{{ $modulo->id }}" 
                    data-modulo-id="{{ $modulo->id }}"
                    value='{"modo":"mostrar_todos"}' 
                    @if(isset($config['modo']) && $config['modo'] === 'mostrar_todos') checked @endif>
