...
@section('content')
    <style>
        .seeder-item.seeder-checked {
            ...
            padding: 0.5rem 1rem;
            /* Más espacio arriba/abajo y a los lados */
    ...
    <div class="row mt-2">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body" id="drop-zone" ondragover="allowDrop(event)" ondrop="dropSeeder(event)"
    ...
    <script>
        ...
        function dropSeeder(ev) {
            ...
            if (seedersSeleccionados.includes(ruta)) {
                mostrarAlerta('warning', 'Este seeder ya fue seleccionado.');
                return;
            }
            ...
            mostrarAlerta('success', 'Seeder agregado.');
        }
        ...
        function eliminarSeeder(ruta, btn) {
            ...
            mostrarAlerta('success', 'Seeder eliminado.');
