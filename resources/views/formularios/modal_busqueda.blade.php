<!-- Modal -->
<div class="modal fade" id="modal_busqueda_{{ $formulario->id }}" tabindex="-1" role="dialog"
    aria-labelledby="modal_busquedaLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
