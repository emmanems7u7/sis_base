...
@can($formulario->id . '.editar')
    <a href="{{ route('respuestas.edit', ['respuesta' => $respuesta, 'modulo' => $modulo]) }}"
        class="btn btn-xs btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
        title="{{   configForm($formulario->id, 'buttons.edit', null, 'text') }}">
...
@can($formulario->id . '.eliminar')
    ...
    <a href="#" class="btn btn-xs btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
        title="{{   configForm($formulario->id, 'buttons.delete', null, 'text') }}" onclick="confirmarEliminacion(
