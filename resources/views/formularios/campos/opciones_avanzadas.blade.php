                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="permitirAgrupacion"
                        ...
                        <!-- BOTÓN GUARDAR -->
                        <div class="mt-4">
                            <button type="button" class="btn btn-sm btn-primary" id="guardarConfiguracionAgrupacion">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <div class="form-check">
                        <input class="form-check-input filtro-check" type="checkbox" value="usuario" id="chkUsuario"
                            {{ $formulario->config['mostrar_usuario'] ?? false ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input class="form-check-input filtro-check" type="checkbox" value="fecha"
            ...
            btnGuardar.addEventListener('click', async function() {
                ...
                try {
                    ...
                    const response = await fetch(
                        "{{ route('formularios.guardarAgrupacion', $formulario->id) }}", {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
